...
const falCdnPattern = {
  protocol: 'https',
  hostname: 'fal-cdn.batuhan-941.workers.dev', // Replace this with the correct domain if needed
  port: '',
  pathname: '/**',
};
...
const nextConfig = {
  images: {
    ...
    remotePatterns: []
      ...
      .concat(openaiPattern)
      .concat(falCdnPattern), // Add the falCdnPattern to the list of remotePatterns
