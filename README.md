...
- Pre-generating prompt script can be found in this (Python notebook)[https://colab.research.google.com/drive/1DJtFMhD81jYtTKh2_a0ql7sn2hm-fOQv] which usees Claude3's Haiuku model 
- API routes directly fetch those prompts from a table instead of generating from OpenAI API. 
- Image Generation saves the image url, prompt and id for each id/prompt pairing. 